...
df <- read.csv("/Users/zhengyuanrui/Graduation_Project/Analysis/data/exp1002.csv")
df

filenames <- list.files("/Users/zhengyuanrui/Graduation_Project/Analysis/data/test_data", pattern = "csv", full.names = TRUE)
